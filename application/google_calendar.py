...
if __name__ == '__main__':
    import pprint
    calendar_id = 'mchmng0grg5vb1q9pdahc2fui4@group.calendar.google.com'
    pprint.pprint(get_upcoming_events(calendar_id=calendar_id))
    #calendar_id2 = '9hsr2ngo831lbbq5pk52ujcicc@group.calendar.google.com'
    #pprint.pprint(get_upcoming_events(calendar_id=calendar_id2))
    #calendar_id3 = 'sufgin9an1pmqgr6o24dks5q40@group.calendar.google.com'
    #pprint.pprint(get_upcoming_events(calendar_id=calendar_id3))